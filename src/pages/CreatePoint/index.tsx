...
const CreatePoint = () => {
    ...
    const [initialPosition, setInitialPosition] = useState<[number, number]>([-15.7964532, -43.3198072]);

    const [selectedUf, setSelectedUf] = useState("0");
    const [selectedCity, setSelectedCity] = useState("0");
    const [selectedItems, setSelectedItems] = useState<number[]>([]);
    const [selectedPosition, setSelectedPosition] = useState<[number, number]>([-15.7964532, -43.3198072]);
